...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  TextFormField buildPriceField() {
    return TextFormField(
      ...
      onSaved: (value) {
        _editedProduct = _editedProduct.coppyWith(price: double.parse(value!));
      },
    );
  }
  ...
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      onSaved: (value) {
        _editedProduct = _editedProduct.coppyWith(description: value);
      },
    );
  }
  ...
  TextFormField buildImageURLField() {
    return TextFormField(
      ...
      onSaved: (value) {
        _editedProduct = _editedProduct.coppyWith(imageUrl: value);
      },
    );
  }
}
